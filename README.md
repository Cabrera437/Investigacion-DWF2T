...
> [!NOTE]
>  En este repositorio se encuentrar la segunda investigacion de DWF relacionada con el Tema swagger y Open Api

> [!IMPORTANT]
> ejecutamos el codigo y colocamos lo siguiente en nuestro navegador esto nos permitira acceder interface de openApi
...
> [!IMPORTANT]
> breve descripcion que hace nuestro ejemplo practico utizando las hermientas ya mencionada: nuestra api cre saludos personalidados con los metos POST , GET DELETE
